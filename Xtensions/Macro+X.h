...
#define LANDSCAPE_LEFT      DEVICE_ORIENTATION == UIDeviceOrientationLandscapeRight
#define PORTRAIT            UIInterfaceOrientationIsPortrait(DEVICE_ORIENTATION)
#define PORTRAIT_REVERSE    DEVICE_ORIENTATION == UIDeviceOrientationPortraitUpsideDown
